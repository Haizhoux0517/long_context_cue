...
| hotpotqa | qwen2.5:14b | comparison | 8000 | middle | low | unknown | retrieve_then_read | exact_match | 0.5000 | 0.5000 | 1.0000 | 2 | False | oracle_not_above_no_evidence |  |  |
...
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | front | medium | unknown | retrieve_then_read | exact_match | 0.0000 | 0.5000 | 0.4000 | 10 | True |  | 0.8000 | 0.8000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 4000 | end | low | unknown | retrieve_then_read | exact_match | 0.1000 | 0.4000 | 0.3000 | 10 | True |  | 0.6667 | 0.6667 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | front | low | unknown | retrieve_then_read | exact_match | 0.2222 | 0.6667 | 0.4444 | 9 | True |  | 0.5000 | 0.5000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | end | low | unknown | retrieve_then_read | exact_match | 0.2500 | 0.6667 | 0.5000 | 12 | True |  | 0.6000 | 0.6000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | middle | low | unknown | retrieve_then_read | exact_match | 0.2000 | 0.7000 | 0.4000 | 10 | True |  | 0.4000 | 0.4000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | front | low | unknown | retrieve_then_read | exact_match | 0.4286 | 0.7143 | 0.2857 | 7 | True |  | -0.5000 | 0.0000 |
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | middle | low | unknown | direct | exact_match | 0.0000 | 0.3333 | 0.6667 | 6 | True |  | 2.0000 | 1.0000 |
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | middle | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.3333 | 0.1667 | 6 | True |  | 0.5000 | 0.5000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.1667 | 0.7500 | 0.4167 | 12 | True |  | 0.4286 | 0.4286 |
| hotpotqa | qwen2.5:14b | multi_hop | 4000 | front | medium | unknown | direct | exact_match | 0.1429 | 0.7143 | 0.8571 | 7 | True |  | 1.2500 | 1.0000 |
| hotpotqa | qwen2.5:14b | multi_hop | 4000 | front | medium | unknown | retrieve_then_read | exact_match | 0.1429 | 0.7143 | 0.7143 | 7 | True |  | 1.0000 | 1.0000 |
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | end | low | unknown | direct | exact_match | 0.2222 | 0.7778 | 0.6667 | 9 | True |  | 0.8000 | 0.8000 |
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | end | low | unknown | retrieve_then_read | exact_match | 0.2222 | 0.7778 | 0.4444 | 9 | True |  | 0.4000 | 0.4000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | front | medium | unknown | retrieve_then_read | exact_match | 0.0000 | 0.4000 | 0.6000 | 5 | True |  | 1.5000 | 1.0000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.5556 | 0.4444 | 9 | True |  | 0.8000 | 0.8000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 4000 | middle | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.6250 | 0.5000 | 8 | True |  | 0.8000 | 0.8000 |
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | middle | medium | unknown | direct | exact_match | 0.4000 | 0.8000 | 0.6000 | 5 | True |  | 0.5000 | 0.5000 |
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | middle | medium | unknown | retrieve_then_read | exact_match | 0.4000 | 0.8000 | 0.4000 | 5 | True |  | 0.0000 | 0.0000 |
...
| hotpotqa | qwen2.5:14b | comparison | 4000 | end | low | unknown | retrieve_then_read | exact_match | 1.0000 | 1.0000 | 1.0000 | 1 | False | oracle_not_above_no_evidence |  |  |
