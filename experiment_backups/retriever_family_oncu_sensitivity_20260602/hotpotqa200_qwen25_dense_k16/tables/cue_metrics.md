...
| hotpotqa | qwen2.5:14b | multi_hop | 4000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.0000 | 0.8000 | 0.8000 | 5 | True |  | 1.0000 | 1.0000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | middle | medium | unknown | retrieve_then_read | exact_match | 0.3333 | 1.0000 | 0.6667 | 9 | True |  | 0.5000 | 0.5000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | end | low | unknown | retrieve_then_read | exact_match | 0.2500 | 0.6667 | 0.8333 | 12 | True |  | 1.4000 | 1.0000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.0000 | 1.0000 | 0.3333 | 3 | True |  | 0.3333 | 0.3333 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | middle | low | unknown | retrieve_then_read | exact_match | 0.2000 | 0.7000 | 0.6000 | 10 | True |  | 0.8000 | 0.8000 |
| hotpotqa | qwen2.5:14b | multi_hop | 4000 | scattered | low | unknown | direct | exact_match | 0.0000 | 0.6000 | 0.3000 | 10 | True |  | 0.5000 | 0.5000 |
| hotpotqa | qwen2.5:14b | multi_hop | 4000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.6000 | 0.3000 | 10 | True |  | 0.5000 | 0.5000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | middle | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.3333 | 0.5000 | 6 | True |  | 1.5000 | 1.0000 |
...
| hotpotqa | qwen2.5:14b | multi_hop | 8000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.0000 | 0.8000 | 0.6000 | 5 | True |  | 0.7500 | 0.7500 |
...
| hotpotqa | qwen2.5:14b | comparison | 8000 | end | low | unknown | retrieve_then_read | exact_match | 0.3333 | 0.3333 | 0.3333 | 3 | False | oracle_not_above_no_evidence |  |  |
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | scattered | low | unknown | direct | exact_match | 0.1667 | 0.7500 | 0.7500 | 12 | True |  | 1.0000 | 1.0000 |
| hotpotqa | qwen2.5:14b | multi_hop | 16000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.1667 | 0.7500 | 0.3333 | 12 | True |  | 0.2857 | 0.2857 |
...
| hotpotqa | qwen2.5:14b | comparison | 8000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.0000 | 1.0000 | 1.0000 | 1 | True |  | 1.0000 | 1.0000 |
