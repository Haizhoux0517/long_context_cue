...
| 2wikimultihopqa | qwen3:14b | multi_hop | 4000 | front | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.5455 | 0.3182 | 22 | True |  | 0.5833 | 0.5833 |
...
| 2wikimultihopqa | qwen3:14b | multi_hop | 16000 | end | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.6667 | 0.1667 | 24 | True |  | 0.2500 | 0.2500 |
...
| 2wikimultihopqa | qwen3:14b | multi_hop | 4000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.3913 | 0.2609 | 23 | True |  | 0.6667 | 0.6667 |
| 2wikimultihopqa | qwen3:14b | multi_hop | 8000 | front | low | unknown | direct | exact_match | 0.0435 | 0.5652 | 0.2174 | 23 | True |  | 0.3333 | 0.3333 |
| 2wikimultihopqa | qwen3:14b | multi_hop | 8000 | front | low | unknown | retrieve_then_read | exact_match | 0.0435 | 0.5652 | 0.2174 | 23 | True |  | 0.3333 | 0.3333 |
...
| 2wikimultihopqa | qwen3:14b | multi_hop | 16000 | middle | low | unknown | retrieve_then_read | exact_match | 0.1154 | 0.4231 | 0.1538 | 26 | True |  | 0.1250 | 0.1250 |
| 2wikimultihopqa | qwen3:14b | multi_hop | 4000 | end | low | unknown | direct | exact_match | 0.0000 | 0.6364 | 0.3636 | 22 | True |  | 0.5714 | 0.5714 |
| 2wikimultihopqa | qwen3:14b | multi_hop | 4000 | end | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.6364 | 0.1818 | 22 | True |  | 0.2857 | 0.2857 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 8000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.5556 | 0.8889 | 0.4444 | 9 | True |  | -0.3333 | 0.0000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 16000 | front | medium | unknown | retrieve_then_read | exact_match | 0.5000 | 1.0000 | 0.8750 | 8 | True |  | 0.7500 | 0.7500 |
...
| 2wikimultihopqa | qwen3:14b | multi_hop | 4000 | middle | low | unknown | retrieve_then_read | exact_match | 0.0417 | 0.5417 | 0.2917 | 24 | True |  | 0.5000 | 0.5000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 8000 | end | medium | unknown | retrieve_then_read | exact_match | 0.3333 | 0.7500 | 0.9167 | 12 | True |  | 1.4000 | 1.0000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 16000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.4286 | 0.7857 | 0.7857 | 14 | True |  | 1.0000 | 1.0000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 8000 | front | low | unknown | retrieve_then_read | exact_match | 0.6000 | 1.0000 | 0.7000 | 10 | True |  | 0.2500 | 0.2500 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 8000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.3846 | 0.8462 | 0.6154 | 13 | True |  | 0.5000 | 0.5000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 16000 | middle | low | unknown | retrieve_then_read | exact_match | 0.5000 | 0.7500 | 0.6250 | 8 | True |  | 0.5000 | 0.5000 |
...
| 2wikimultihopqa | qwen3:14b | multi_hop | 8000 | end | low | unknown | retrieve_then_read | exact_match | 0.0476 | 0.3333 | 0.2381 | 21 | True |  | 0.6667 | 0.6667 |
...
| 2wikimultihopqa | qwen3:14b | multi_hop | 16000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.0526 | 0.4737 | 0.0526 | 19 | True |  | 0.0000 | 0.0000 |
| 2wikimultihopqa | qwen3:14b | comparison | 16000 | end | low | unknown | direct | exact_match | 0.4615 | 0.8462 | 0.6923 | 13 | True |  | 0.6000 | 0.6000 |
| 2wikimultihopqa | qwen3:14b | comparison | 16000 | end | low | unknown | retrieve_then_read | exact_match | 0.4615 | 0.8462 | 0.6154 | 13 | True |  | 0.4000 | 0.4000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 4000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.6667 | 0.8333 | 0.5000 | 6 | True |  | -1.0000 | 0.0000 |
...
| 2wikimultihopqa | qwen3:14b | multi_hop | 8000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.0500 | 0.4000 | 0.0500 | 20 | True |  | 0.0000 | 0.0000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 4000 | middle | medium | unknown | retrieve_then_read | exact_match | 0.3333 | 0.7778 | 0.6667 | 9 | True |  | 0.7500 | 0.7500 |
| 2wikimultihopqa | qwen3:14b | comparison | 8000 | end | low | unknown | direct | exact_match | 0.5000 | 0.8750 | 0.6250 | 8 | True |  | 0.3333 | 0.3333 |
| 2wikimultihopqa | qwen3:14b | comparison | 8000 | end | low | unknown | retrieve_then_read | exact_match | 0.5000 | 0.8750 | 0.6250 | 8 | True |  | 0.3333 | 0.3333 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 4000 | front | low | unknown | retrieve_then_read | exact_match | 0.5556 | 0.8889 | 0.3333 | 9 | True |  | -0.6667 | 0.0000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 4000 | middle | low | unknown | retrieve_then_read | exact_match | 0.8750 | 1.0000 | 1.0000 | 8 | True |  | 1.0000 | 1.0000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 8000 | middle | medium | unknown | retrieve_then_read | exact_match | 0.4444 | 0.6667 | 0.6667 | 9 | True |  | 1.0000 | 1.0000 |
...
| 2wikimultihopqa | qwen3:14b | comparison | 16000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.6250 | 1.0000 | 1.0000 | 8 | True |  | 1.0000 | 1.0000 |
