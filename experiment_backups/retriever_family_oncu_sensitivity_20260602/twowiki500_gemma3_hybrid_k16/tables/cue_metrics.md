...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2wikimultihopqa | gemma3:12b | multi_hop | 4000 | front | low | unknown | direct | exact_match | 0.0455 | 0.6818 | 0.2273 | 22 | True |  | 0.2857 | 0.2857 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 8000 | middle | low | unknown | retrieve_then_read | exact_match | 0.5000 | 0.8333 | 0.5000 | 6 | True |  | 0.0000 | 0.0000 |
| 2wikimultihopqa | gemma3:12b | multi_hop | 16000 | end | low | unknown | direct | exact_match | 0.0417 | 0.5417 | 0.2917 | 24 | True |  | 0.5000 | 0.5000 |
| 2wikimultihopqa | gemma3:12b | multi_hop | 16000 | end | low | unknown | retrieve_then_read | exact_match | 0.0417 | 0.5417 | 0.1667 | 24 | True |  | 0.2500 | 0.2500 |
...
| 2wikimultihopqa | gemma3:12b | multi_hop | 16000 | middle | low | unknown | retrieve_then_read | exact_match | 0.0385 | 0.5385 | 0.2308 | 26 | True |  | 0.3846 | 0.3846 |
| 2wikimultihopqa | gemma3:12b | multi_hop | 4000 | end | low | unknown | direct | exact_match | 0.0455 | 0.4091 | 0.3182 | 22 | True |  | 0.7500 | 0.7500 |
| 2wikimultihopqa | gemma3:12b | multi_hop | 4000 | end | low | unknown | retrieve_then_read | exact_match | 0.0455 | 0.4091 | 0.1818 | 22 | True |  | 0.3750 | 0.3750 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 8000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.6667 | 0.7778 | 0.7778 | 9 | True |  | 1.0000 | 1.0000 |
...
| 2wikimultihopqa | gemma3:12b | multi_hop | 4000 | middle | low | unknown | retrieve_then_read | exact_match | 0.0000 | 0.6667 | 0.2917 | 24 | True |  | 0.4375 | 0.4375 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 16000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.3571 | 0.6429 | 0.5000 | 14 | True |  | 0.5000 | 0.5000 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 4000 | front | medium | unknown | retrieve_then_read | exact_match | 0.5455 | 0.7273 | 0.6364 | 11 | True |  | 0.5000 | 0.5000 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 8000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.5385 | 0.9231 | 0.5385 | 13 | True |  | 0.0000 | 0.0000 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 16000 | front | low | unknown | retrieve_then_read | exact_match | 0.6667 | 1.0000 | 0.6667 | 6 | True |  | 0.0000 | 0.0000 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 16000 | end | medium | unknown | retrieve_then_read | exact_match | 0.8000 | 0.8000 | 1.0000 | 5 | False | oracle_not_above_no_evidence |  |  |
...
| 2wikimultihopqa | gemma3:12b | comparison | 16000 | middle | low | unknown | retrieve_then_read | exact_match | 0.6250 | 0.8750 | 0.6250 | 8 | True |  | 0.0000 | 0.0000 |
| 2wikimultihopqa | gemma3:12b | comparison | 4000 | end | low | unknown | direct | exact_match | 0.4167 | 1.0000 | 0.5000 | 12 | True |  | 0.1429 | 0.1429 |
| 2wikimultihopqa | gemma3:12b | comparison | 4000 | end | low | unknown | retrieve_then_read | exact_match | 0.4167 | 1.0000 | 0.5833 | 12 | True |  | 0.2857 | 0.2857 |
| 2wikimultihopqa | gemma3:12b | multi_hop | 8000 | end | low | unknown | direct | exact_match | 0.0476 | 0.4762 | 0.4286 | 21 | True |  | 0.8889 | 0.8889 |
| 2wikimultihopqa | gemma3:12b | multi_hop | 8000 | end | low | unknown | retrieve_then_read | exact_match | 0.0476 | 0.4762 | 0.2381 | 21 | True |  | 0.4444 | 0.4444 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 16000 | end | low | unknown | retrieve_then_read | exact_match | 0.6923 | 0.6923 | 0.4615 | 13 | False | oracle_not_above_no_evidence |  |  |
...
| 2wikimultihopqa | gemma3:12b | comparison | 4000 | scattered | low | unknown | retrieve_then_read | exact_match | 0.5000 | 1.0000 | 0.5000 | 6 | True |  | 0.0000 | 0.0000 |
...
| 2wikimultihopqa | gemma3:12b | multi_hop | 16000 | front | low | unknown | retrieve_then_read | exact_match | 0.0741 | 0.7037 | 0.1852 | 27 | True |  | 0.1765 | 0.1765 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 4000 | middle | medium | unknown | retrieve_then_read | exact_match | 0.6667 | 0.5556 | 0.8889 | 9 | False | oracle_not_above_no_evidence |  |  |
| 2wikimultihopqa | gemma3:12b | comparison | 8000 | end | low | unknown | direct | exact_match | 0.5000 | 1.0000 | 0.5000 | 8 | True |  | 0.0000 | 0.0000 |
| 2wikimultihopqa | gemma3:12b | comparison | 8000 | end | low | unknown | retrieve_then_read | exact_match | 0.5000 | 1.0000 | 0.5000 | 8 | True |  | 0.0000 | 0.0000 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 4000 | scattered | medium | unknown | retrieve_then_read | exact_match | 0.4167 | 0.9167 | 0.3333 | 12 | True |  | -0.1667 | 0.0000 |
...
| 2wikimultihopqa | gemma3:12b | comparison | 4000 | front | low | unknown | retrieve_then_read | exact_match | 0.8889 | 0.8889 | 0.6667 | 9 | False | oracle_not_above_no_evidence |  |  |
...
| 2wikimultihopqa | gemma3:12b | comparison | 8000 | front | medium | unknown | retrieve_then_read | exact_match | 0.7778 | 1.0000 | 0.6667 | 9 | True |  | -0.5000 | 0.0000 |
